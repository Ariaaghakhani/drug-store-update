    ...
    <div class="relative mb-12">
      ...
      <div class="relative">
        <input
          ...
          maxlength="11"
          class="w-full px-4 ps-12 h-14 text-lg border-2 rounded-2xl focus:ring-4 focus:ring-teal-500/20 focus:border-teal-500 transition-all"
          :class="{
        ...
        <div
          class="absolute start-4 top-1/2 -translate-y-1/2 text-gray-400 flex justify-center items-center"
        >
