      ...
      <div>
        ...
        <div class="relative h-14">
          <input
            ...
            class="w-full h-full px-4 pe-12 text-lg border-2 rounded-2xl focus:ring-4 focus:ring-teal-500/20 focus:border-teal-500 transition-all"
            :class="{
          ...
          <button
            type="button"
            class="absolute end-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 flex justify-center items-center"
