    ...
    <div class="relative">
      <Transition name="sk">
        ...
        <div v-if="pending" key="sk" class="space-y-4">
          ...
          <div class="grid lg:grid-cols-2 gap-4">
            ...
            <UCard :ui="{ body: 'p-0' }">
              ...
              >
                <USkeleton class="w-5 h-5 rounded flex-shrink-0" />
              ...
              <div
                class="flex justify-end gap-2 px-4 sm:px-6 py-3.5 border-t border-gray-100 dark:border-gray-800"
              >
        ...
        <div v-else key="content" class="space-y-4">
          ...
          <div class="grid lg:grid-cols-2 gap-4">
            ...
            <UCard :ui="{ body: 'p-0' }">
              ...
              <div class="flex items-center justify-between px-4 sm:px-6 py-4">
                <div class="flex items-center gap-3">
                  <div
                    class="w-9 h-9 rounded-lg bg-info/10 flex items-center justify-center flex-shrink-0"
                  >
                    <UIcon
                ...
                <USwitch v-model="twoFA.sms" size="lg" :ui="switchUi" />
              </div>
            </UCard>
          </div>
            ...
            <div class="divide-y divide-gray-100 dark:divide-gray-800">
              <div
                ...
                :class="[
                  ...
                  session.current && 'bg-brand-500/5 dark:bg-brand-500/10',
                ]"
              >
                <div
                  :class="[
                ...
                <div
                  class="flex-shrink-0 text-left flex flex-col items-end gap-1.5"
                >
                  <p class="text-[11px] text-gray-400 dark:text-gray-500">
                    {{ session.lastActive }}
                  </p>
              ...
              >
                <div
                  :class="[
                    ...
                    entry.success ? 'bg-brand-500' : 'bg-[var(--color-danger)]',
                  ]"
                />
                <div class="flex-1 min-w-0">
          ...
          <UCard
            :ui="{ body: 'p-0' }"
            class="ring-1 ring-[var(--color-danger)]/25 dark:ring-[var(--color-danger)]/20"
          >
            <div
              class="flex items-center gap-2 px-4 sm:px-6 py-4 border-b border-gray-100 dark:border-gray-800"
            >
              ...
              <div class="flex items-center justify-between px-4 sm:px-6 py-4">
                <div>
                  ...
                  <p
                    class="text-[11px] text-gray-400 dark:text-gray-500 mt-0.5"
                  >
                    این عملیات غیرقابل بازگشت است و تمام اطلاعات شما حذف خواهد
                    شد
                  </p>
                </div>
                <UButton variant="outline" color="error" size="sm"
